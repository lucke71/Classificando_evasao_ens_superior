cria_tabela_evasao = function(co_ies,tipo_evasao){
	...
	with enem_empilhado as (
		...
		SELECT  nu_ano,
				...
				q60 as q038,
				q57 as q039,
				cast(case when q23=' .' then NULL end as numeric) as q40,
				q22 as q041,
		...
		SELECT	nu_ano,
				...
				q28 as q030,
				q29 as q031,
				case when q32='H' then NULL end as q032,
				q31 as q033,
				q32 as q034,
				case when q33='H' then NULL end as q035,
				NULL as q036,
				NULL as q037,
				NULL as q038,
				NULL as q039,
		...
		alunos_2010 as(
			...
			where ",paste0("t1.co_ies in (",paste(co_ies,collapse=","),")"),"
		),
		...
		evasao as (
			...
			ult_sit as (
				...
				from (
					select	t1.*,
							max(ano) over (partition by co_aluno,co_ies) as ano_max
					from ies_df t1
				)tab
				where ano_max=ano
			),
